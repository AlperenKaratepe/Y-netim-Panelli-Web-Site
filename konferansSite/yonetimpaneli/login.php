      ...
      <p class="login-box-msg">Giriş yapmak için bilgilerinizi yazınız...</p>
        ...
        if($_POST)
        {
           ...
           if(!empty($_POST["kullanici"]) && !empty($_POST["sifre"]))
           {
                ...
                $kontrol=$VT->Getir("kullanicilar","WHERE kullanici=? AND sifre=?",array($kullanici,$sifre),"ORDER BY ID ASC",1);
                    if($kontrol!=false)
                    {
      ...
      <form action="#" method="post">
        ...
        <div class="row">
          ...
          <div class="col-4">
            ...
            <div class="col-8">
                <br>
                <a href="<?=SITE?>giris-yap"class="btn btn-success" style="">Kullanıcı Girişi </a>
