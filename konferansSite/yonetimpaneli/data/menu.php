<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=SITE?>" class="brand-link">
      <img src="<?=SITE?>dist/img/iste_arma.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="<?=SITE?>tümKonferanslar" class="nav-link">
                    <i class="nav-icon fas fa-th"></i>
                    <p>
                       Konferansları Listele
                    </p>
                </a>
            </li>
            <li class="nav-item">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
               ...
               $modul=$VT->Getir("moduller","WHERE durum=?",array(1),"ORDER BY ID ASC");
                    ...
                    if($modul!=false)
                    {
                        ...
                        for($i=0;$i<count($modul);$i++)
                        {
                            ?>
                            <li class="nav-item">
                                <a href="<?=SITE?>liste/<?=$modul[$i]['tablo']?>" class="nav-link">
